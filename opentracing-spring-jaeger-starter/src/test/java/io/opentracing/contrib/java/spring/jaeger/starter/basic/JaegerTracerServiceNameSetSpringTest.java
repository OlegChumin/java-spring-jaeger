...
/**
 * Описывает поведение компонента JaegerTracerServiceNameSetSpringTest.
 */
@TestPropertySource(
    properties = {
...
@org.junit.jupiter.api.DisplayName("Тесты компонента JaegerTracerServiceNameSetSpringTest")
