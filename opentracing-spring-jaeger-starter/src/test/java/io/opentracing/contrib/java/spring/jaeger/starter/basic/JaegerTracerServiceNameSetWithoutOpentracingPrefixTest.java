...
/**
 * Описывает поведение компонента JaegerTracerServiceNameSetWithoutOpentracingPrefixTest.
 */
@TestPropertySource(
    properties = {
...
@org.junit.jupiter.api.DisplayName("Тесты компонента JaegerTracerServiceNameSetWithoutOpentracingPrefixTest")
