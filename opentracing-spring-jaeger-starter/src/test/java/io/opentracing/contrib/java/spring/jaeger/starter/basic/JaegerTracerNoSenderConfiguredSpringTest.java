...
/**
 * Описывает поведение компонента JaegerTracerNoSenderConfiguredSpringTest.
 */
@TestPropertySource(
    properties = {
...
@org.junit.jupiter.api.DisplayName("Тесты компонента JaegerTracerNoSenderConfiguredSpringTest")
