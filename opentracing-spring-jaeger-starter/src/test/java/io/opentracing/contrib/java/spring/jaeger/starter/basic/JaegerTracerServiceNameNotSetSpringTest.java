...
/**
 * Описывает поведение компонента JaegerTracerServiceNameNotSetSpringTest.
 */
@TestPropertySource(
    properties = {
...
@org.junit.jupiter.api.DisplayName("Тесты компонента JaegerTracerServiceNameNotSetSpringTest")
