...
/**
 * Описывает поведение компонента JaegerTracerB3CustomerizerEnabledSpringTest.
 */
@TestPropertySource(
    properties = {
...
@org.junit.jupiter.api.DisplayName("Тесты компонента JaegerTracerB3CustomerizerEnabledSpringTest")
