...
/**
 * Описывает поведение компонента JaegerTracerServiceNameSetExplicitTest.
 */
@TestPropertySource(
    properties = {
...
@org.junit.jupiter.api.DisplayName("Тесты компонента JaegerTracerServiceNameSetExplicitTest")
